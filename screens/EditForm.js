...
export default function EditForm({ editNote, item, discardChangesAlert, setNoteEdit }) {
  return (
          ...
          <View>
            <View style={styles.modalHeader}>
              <MaterialIcons
                ...
                size={24}
                color={colors.dark}
                onPress={() => discardChangesAlert(setNoteEdit)}
              />
              <Text style={stylesheet.headerText}>Edit Note</Text>
              { props.isSubmitting ? 
